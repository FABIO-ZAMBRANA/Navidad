...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const nombre = (params.get('name') || 'MABEL').toUpperCase();

    // Insertar el nombre en la página en mayúsculas
    document.querySelector('.container').insertAdjacentHTML('afterbegin', `<strong>${nombre} ❤️</strong>`);

    // Agregar el mensaje en español
    const parrafo = document.createElement('p');
    parrafo.textContent = "Que esta Navidad esté llena de alegría, amor y momentos inolvidables. Disfruta de cada instante con tus seres queridos, y recuerda que los mejores regalos son aquellos que vienen del corazón. ¡FELIZ NAVIDAD!";
